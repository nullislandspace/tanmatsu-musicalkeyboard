...
install: build
install:
	cd badgelink/tools; ./badgelink.sh appfs upload musicalkeyboard "MyFirstPiano" 0 ../../$(BUILD)/musicalkeyboard.bin

.PHONY: run
run:
	cd badgelink/tools; ./badgelink.sh start musicalkeyboard
